...
parser.add_argument('--arch', default='ResNet-50')
...
parser.add_argument('--logdir', default='runs/res_glas')
parser.add_argument('--save-path', default='checkpoint_res.pth', help='Path to save the best model')
...
def main(args):
    ...
    if args.arch == "ResNet-18":
    ...
    elif args.arch ==  "ResNet-34":
        model = models.resnet34(pretrained=args.pretrained)
    elif args.arch ==  "ResNet-50":
        model = models.resnet50(pretrained=args.pretrained)
    elif args.arch ==  "ResNet-101":
        ...
        print("ResNet arch usage: ResNet-<layers>, only allow 18, 34, 50, 101, 152")
        os._exit(0)
    ...
    transform = transforms.Compose([
        transforms.Resize((args.image_size, args.image_size)),  # 224
        transforms.ToTensor(),
        normalize
    ])
