...
def train(model, train_ld, test_ld, device,
    ...
    for ep in range(1, epochs+1):
        ...
        if ep % 20 == 0:
            ...
            plot_all_metrics(history, out_path='./Classification/One-shot/ResNet18/', ep=ep)
        if test_acc > best_acc:
            best_acc, no_improve = test_acc, 0
            torch.save(model.state_dict(), './Classification/One-shot/ResNet18/best_model_pretraining.pth')
        else:
            no_improve += 1
            """
...
if __name__ == '__main__':
    ...
    plot_all_metrics(history, out_path='./Classification/One-shot/ResNet18/', ep='fin')
